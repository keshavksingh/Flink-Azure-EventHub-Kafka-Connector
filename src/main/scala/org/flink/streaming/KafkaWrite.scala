...
object KafkaWrite {
  def main(args: Array[String]) {
    ...
    val dataStream: DataStream[String] = env.fromElements("Hello KafkaSinkBuilder World", "Hello KafkaSinkBuilder this is Flink!")
    dataStream.print()
 ...
 */
    ...
    dataStream.sinkTo(KafkaSinkBuilder)
/*
    ...
    */
    ...
    env.execute("Azure EventHub Kafka Write Example!")
